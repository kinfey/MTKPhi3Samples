...
enum class TokenizerType { Undefined, SentencePiece, HuggingFace, Tiktoken };
...
public:
    ...
    std::unique_ptr<Tokenizer> create(const std::vector<std::string>& tokenizerFiles, Args&&... args) {
